const usersData = [
  {id: 0, name: 'Devona Slater', registered: '01/01/18', role: 'Admin', status: 'Pending'},
  {id: 1, name: 'Daniel Hammond', registered: '02/01/18', role: 'Staff', status: 'Banned'},
  {id: 2, name: 'Russell Horn', registered: '03/01/18', role: 'Provider', status: 'Active'},
  {id: 3, name: 'Mark Schlessinger', registered: '04/01/18', role: 'Provider', status: 'Inactive'},
