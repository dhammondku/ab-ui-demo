    ...
    return (
      <Dropdown nav className="d-md-down-none" isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right>
          ...
          <DropdownItem><i className="icon-chart text-info"></i> Analytics report is ready</DropdownItem>
          <DropdownItem><i className="icon-speedometer text-warning"></i> Server Disconnected</DropdownItem>
  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <img src={'assets/img/avatars/6.jpg'} className="img-avatar" alt="admin@anesthesiabeacons.com" />
        </DropdownToggle>
        <DropdownMenu right>
    ...
    return (
      <Dropdown nav className="d-md-down-none" isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right className="dropdown-menu-lg">
          ...
          <DropdownItem>
            <div className="small mb-1">Task 1 <span
              className="float-right"><strong>0%</strong></span></div>
            <Progress className="progress-xs" color="info" value={0} />
          </DropdownItem>
          <DropdownItem>
            <div className="small mb-1">Task 2 <span className="float-right"><strong>25%</strong></span>
            </div>
            <Progress className="progress-xs" color="danger" value={25} />
          </DropdownItem>
          <DropdownItem>
            <div className="small mb-1">Task 3 <span className="float-right"><strong>50%</strong></span>
            </div>
            <Progress className="progress-xs" color="warning" value={50} />
          </DropdownItem>
          <DropdownItem>
            <div className="small mb-1">Task 4 <span className="float-right"><strong>75%</strong></span>
            </div>
